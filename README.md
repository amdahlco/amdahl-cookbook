...
- **Evals** — a graded report-card over your answers: fire a code-defined eval, poll the run, read the pass/partial/fail verdict + per-grader breakdown. [Recipe](prompts/agent-platform/evals.md).
