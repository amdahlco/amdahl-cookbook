...
**Wave 1 — gather:**
- Customer voice → `search` { action: query, semantic }: how our actual customers describe us, this category, and the problem — on calls, verbatim, with roles. Pull the recurring phrases.
