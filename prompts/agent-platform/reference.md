...
| [Subscriptions](subscriptions.md) | `subscriptions.list_kinds`, `subscriptions.create`, `subscriptions.list`, `subscriptions.get`, `subscriptions.list_fires`, `subscriptions.update`, `subscriptions.delete`, `subscriptions.test_fire` |
